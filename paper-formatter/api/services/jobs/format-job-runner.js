...
export async function processFormatJob(jobId, documentRecord, profileId) {
    const updateFormatJob = (patch) => jobRepo.updateJob(jobId, patch).catch((error) => console.error(`[format] Failed to update job ${jobId}:`, error.message));
    try {
