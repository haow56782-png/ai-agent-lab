...
function buildFormatterFindingContext(findings) {
...
export async function callFormatterService(documentBuffer, filename, profileId, findingContext = []) {
    ...
    if (contentType.includes("multipart")) {
        ...
        const formattedFile = responseFormData.get("formatted");
        const diffFile = responseFormData.get("diff");
        return {
