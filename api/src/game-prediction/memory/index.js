 ...
 */
export async function buildMemoryContext(store, identity, currentBankroll, startingBankroll) {
    ...
    const profile = await getOrCreateProfile(identity.playerId, events, existingProfile);
 ...
 */
export async function recordAndRebuild(store, identity, event, currentBankroll, startingBankroll) {
