 ...
 */
export function vibToAddyosmani(vib) {
    const warnings = [];
    /* ── name ── */
 ...
 */
export function addyosmaniToVib(skill) {
    const warnings = [];
    const data = {
        /* core — direct copy */
        ...
        category: ADDY_DEFAULTS.category,
        version: ADDY_DEFAULTS.version,
        owner: ADDY_DEFAULTS.owner,
        /* empty arrays */
        inputs: [],
        outputs: [],
        tools: [],
...
//# sourceMappingURL=addyosmani.js.map