 ...
 */
export declare const OBJECT_GRAPH_SCHEMA_VERSION: "object-graph.v0.1";
export declare const CONTINUATION_VOTE_THRESHOLDS: {
    readonly confirmedEdge: 3;
    readonly ambiguousEdge: 2;
};
...
export type DrawingWrapMode = "inline" | "wrapNone" | "wrapSquare" | "wrapTight" | "wrapThrough" | "wrapTopAndBottom" | "floating" | "unknown";
export type ContinuationSignal = "tbl_header_match" | "schema_fingerprint_match" | "adjacent_no_caption" | "adjacent_no_body_text" | "caption_text_continuation";
export type ContinuationDecision = "edge" | "edge_with_warning" | "no_edge";
export type ObjectGraphWarningCode = "parse_failed" | "unsupported_object" | "caption_unbound" | "continuation_ambiguous" | "invariant_violation";
