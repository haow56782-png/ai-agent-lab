...
export function detectTableContinuation(graph: ObjectGraph): RuleDetection[] {
...
function createDetection(edge: ContinuesEdge, tableById: Map<string, TableObject>): RuleDetection {
...
function isTableObject(node: ObjectGraph["nodes"][number]): node is TableObject {
