...
import type { AgentDebateOutput, BankrollContext, Stance } from "./types.js";
...
export function probabilityAnalyst(
  signal: Signal,
  decision: DecisionOutput,
  _riskPref: RiskPreference,
): AgentDebateOutput {
  ...
  return makeOutput(
    "probability-analyst",
    "Probability Analyst — evaluates statistical soundness and expected value",
    stance, score, reasoning, objections, adjustments,
  );
}
...
export function riskManager(
  signal: Signal,
  decision: DecisionOutput,
  simulationOutput: SimulationOutput | undefined,
  ...
  return makeOutput(
    "risk-manager",
    "Risk Manager — assesses bankroll exposure, ruin probability, and risk levels",
    stance, score, reasoning, objections, adjustments,
  );
}
...
export function strategyCritic(
  signal: Signal,
  decision: DecisionOutput,
  riskPreference: RiskPreference,
): AgentDebateOutput {
  ...
  return makeOutput(
    "strategy-critic",
    "Strategy Critic — evaluates strategy selection and decision consistency",
    stance, score, reasoning, objections, adjustments,
  );
}
...
export function learningAuditor(
  learningOutput: LearningOutput | undefined,
  signal: Signal,
  ...
  if (!learningOutput) {
    return makeOutput(
      "learning-auditor",
      "Learning Auditor — reviews calibration drift and learning signals",
      "SUPPORT", 0.7,
      "No learning data available. Skipping learning audit.",
      [], [],
    );
  }
  ...
  return makeOutput(
    "learning-auditor",
    "Learning Auditor — reviews calibration drift, Brier score, and learning signals",
    stance, score, reasoning, objections, adjustments,
  );
}
