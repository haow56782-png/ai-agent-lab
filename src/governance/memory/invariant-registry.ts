...
const DEFAULT_INVARIANTS: InvariantEntry[] = [
  {
    id: "INV-001",
    ...
    category: "authority",
    description:
      "Claude Opus owns final arbitration authority for all architecture decisions. No other model may serve as final arbiter.",
  ...
  },
  {
    ...
    category: "authority",
    description:
      "External cognitive reviewers (OpenAI, etc.) provide advisory review only. They cannot finalize a freeze decision.",
    enacted: "2026-05-07T00:00:00.000Z",
    enactedBy: "P2.0-Governance-Foundation",
    relatedADRs: [],
    immutable: true,
  },
  {
    ...
    category: "security",
    description:
      "The governance layer (ADR store, freeze gate, review pipeline) must never read, store, or transmit API keys, tokens, or secrets.",
    enacted: "2026-05-07T00:00:00.000Z",
    enactedBy: "P2.0-Governance-Foundation",
    relatedADRs: [],
    immutable: true,
  },
  {
    ...
    category: "boundary",
    description:
      "The runtime execution layer (DeepSeek, tool execution) cannot modify governance rules, freeze gate state, or constitutional invariants.",
    enacted: "2026-05-07T00:00:00.000Z",
    enactedBy: "P2.0-Governance-Foundation",
    relatedADRs: [],
    immutable: true,
  },
  {
    ...
    category: "protocol",
    description:
      "Any change to a constitutional invariant requires L3 Freeze Gate approval. No bypass is permitted.",
    enacted: "2026-05-07T00:00:00.000Z",
    enactedBy: "P2.0-Governance-Foundation",
    relatedADRs: [],
    immutable: true,
  },
  {
    ...
    category: "authority",
    description:
      "An external reviewer model cannot authorize its own governance escalation or grant itself additional authority.",
    enacted: "2026-05-07T00:00:00.000Z",
    enactedBy: "P2.0-Governance-Foundation",
    relatedADRs: [],
    immutable: true,
  },
  {
    ...
    category: "authority",
    description:
      "Models containing 'mini', 'flash', or equivalent lightweight designation cannot serve as the final reviewer in a Freeze Gate pipeline.",
    enacted: "2026-05-07T00:00:00.000Z",
    enactedBy: "P2.0-Governance-Foundation",
    relatedADRs: [],
    immutable: true,
  },
  {
    id: "INV-008",
    invariant:
      "External reviewer is external cognition injection, not routing authority",
    severity: "ARCHITECTURE",
    category: "boundary",
    description:
      "External reviewers (OpenAI) are cognition injection for architecture critique only. They do not participate in model routing decisions.",
    enacted: "2026-05-07T00:00:00.000Z",
    enactedBy: "P2.0-Governance-Foundation",
    relatedADRs: [],
    immutable: true,
...
export class InvariantRegistry {
  private invariants: Map<string, InvariantEntry>;
  ...
  getInvariantsBySeverity(
    ...
    return this.getStandardInvariants().filter(
  ...
  registerInvariant(entry: Omit<InvariantEntry, "enacted"> & { enacted?: string }): InvariantEntry {
    const full: InvariantEntry = {
      ...entry,
  ...
  getTouchedInvariants(invariantIds: string[]): InvariantEntry[] {
    return invariantIds
      ...
      .filter((e): e is InvariantEntry => e !== undefined)
      .map((i) => ({ ...i }));
  }
