 ...
 *  ============================================================ */
import { classifyExecutionBoundary, getRecommendedExecutor, boundaryRequiresPlan, boundaryRequiresArbitration, describeExecutionBoundary, ExecutionBoundary, } from "./governance/review/external-review-policy.js";
/**
 ...
 */
export function selectModel(boundary, opusModel) {
    switch (boundary) {
 ...
 */
export function boundaryRequiresOpus(boundary) {
    return boundary === "E2" || boundary === "E3";
}
export const BOUNDARY_ENFORCEMENT_MESSAGE = "This task requires Opus-level execution (E2/E3 boundary) but no Opus model is configured. "
