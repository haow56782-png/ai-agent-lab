...
const conservativeCashout: Strategy = {
...
const balancedMultiplier: Strategy = {
...
const aggressiveMultiplier: Strategy = {
...
export const crashStrategies: Record<string, Strategy> = {
