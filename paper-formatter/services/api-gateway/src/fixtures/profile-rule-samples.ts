...
export const CAFA_RULE_SEED: CafaRuleSeed = {
  school: "CAFA",
  ruleVersion: "2025",
  fixtureVersion: "v0.1",
...
export const CAFA_PROFILE_RULE_SAMPLE: ProfileRuleSample = {
  schoolId: "cafa",
  name: "中央美术学院",
  version: "v2023.10",
...
export const PROFILE_RULE_SAMPLES: ProfileRuleSample[] = [
  CAFA_PROFILE_RULE_SAMPLE,
];

export function getProfileRuleSample(schoolId: string): ProfileRuleSample | null {
  return PROFILE_RULE_SAMPLES.find((sample) => sample.schoolId === schoolId) || null;
}

export function getCafaRuleIds(): string[] {
