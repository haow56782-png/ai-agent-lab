// Shared finding download guard used by client and API gateway.
// The guard is pure: it reads job status, findings, and P1 exemption only.
// Page/currentPage never participates in the decision.
// This keeps download eligibility tied to Finding business facts.
import type { ExemptionRecord, FindingContract, FindingStatus } from "./finding-contract";
