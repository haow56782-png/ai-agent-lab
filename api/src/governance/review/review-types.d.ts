...
export type ReviewDimension = "hidden_assumptions" | "missing_invariants" | "coupling_risk" | "overengineering" | "underengineering" | "maintenance_risk" | "state_consistency" | "event_sourcing" | "cross_module_interaction" | "milestone_violation";
 ...
 */
export type ProviderErrorCode = "MISSING_API_KEY" | "NETWORK_ERROR" | "TIMEOUT" | "INVALID_JSON" | "SCHEMA_VALIDATION_FAILED" | "PROVIDER_REJECTED";
/**
...
export declare const DEFAULT_OPENAI_REVIEWER_CONFIG: OpenAIReviewerConfig;
/**
...
export interface RoutingDecisionLog {
    ...
    role: "ARCHITECTURE_GOVERNOR" | "COGNITIVE_REVIEWER" | "IMPLEMENTATION_PLANNER" | "MECHANICAL_EXECUTOR";
    reason: string;
    timestamp: string;
    inputSummary: string;
