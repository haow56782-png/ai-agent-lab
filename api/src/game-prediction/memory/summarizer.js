 ...
 */
export function generateMemorySummary(context) {
    const parts = [];
    // Session overview
 ...
 */
export function generateConstraints(session, semantic, profile) {
    const constraints = [];
 ...
 */
export function generatePersistentWarnings(profile, semantic) {
...
function getTopStrategy(affinity) {
    let top = null;
    let max = 0;
